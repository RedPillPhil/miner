...
s1.async=true;
s1.src='https://embed.tawk.to/64d37d55cc26a871b02e3902/1h7d236qi';
s1.charset='UTF-8';
        ...
        <div class="App">
            <div class="home">
                <div class="container">
                    <div class="header">
                        <div>
                            <a class="nav-item" href="docs/whitepaper.pdf" target="_blank" rel="noopener noreferrer">
                                WHITEPAPER
                            </a>
                            <a class="nav-item" href="https://hazecrypto.net/audit/Baked_Pizza" target="_blank" rel="noopener noreferrer">
                                HAZE
                            </a>
							 <a class="nav-item" href="https://app.solidproof.io/projects/baked-pizza" target="_blank" rel="noopener noreferrer">
                                SOLIDPROOF
                            </a>
                        </div>
                    ...
                    <h1 class="slogan">The BNB Pool with the finest daily <br /> return and highest referral reward</h1>
...
<div class="dataRow">
  <div class="name">Your Mining Power</div>
  <div class="value">{{ hatcheryMiners }}</div>
</div>
...
<span class="ant-input-affix-wrapper antInput">
  ...
  <input class="ant-input" v-model="buyAmount" type="text" readonly>
                            ...
                            <button class="buyButton" @click.prevent="bakePizza">Add Mining Power</button>
                            <div class="actionWrapper">
                                ...
                                <div class="actionButtons">
                                    <button @click.prevent="rebakePizza">Boost Mining Power</button>
                                    <button>Claim Slinky</button>
                        ...
                        <div class="box rightBox">
                            <div class="referral">
                                <h1>Referral Link</h1>
                                <p>Earn 15% of the BNB used to bake Pizza from anyone who uses your referral link</p>
                    ...
                    <footer>
                        <div class="buttonGroup">
                            ...
                            <a class="nav-item" @click.prevent="toggleContest">
                                CREATORS CONTEST
                            </a>
                        </div>
                        <div class="socialMedias">
                            <a href="https://bscscan.com/address/0xaef10dd120e79f60d61048c306b7379c21d56a38"
                            ...
                            <a href="https://twitter.com/BakedPizzaApp" target="_blank" rel="noopener noreferrer">
                            ...
                            <a href="https://t.me/bakedpizzacommunity" target="_blank" rel="noopener noreferrer">
							 ...
							 <a href="https://hazecrypto.net/audit/Baked_Pizza" target="_blank" rel="noopener noreferrer">
                                <img src="images/FinalLogo.png"
                                    alt="haze">
                            </a>
							<a href="https://app.solidproof.io/projects/baked-pizza" target="_blank" rel="noopener noreferrer">
